...
export default function Results() {
    return (
        <div id="frailtyModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Frailty Risk</h5>
                ...
                <div class="modal-body">
                        ...
                        <h4 class="text-success"><strong>Low - Pre-Frail (under 25%)</strong></h4>
                        ...
                        <h4 class="text-success"><strong>Mildly Frail (between 25% and 29%)</strong></h4>
                        ...
                        <h4 class="text-warning"><strong>Moderately Frail (between 30% and 39%)</strong></h4>
                        ...
                        <h4 class="text-danger"><strong>Severely Frail (over 40%)</strong></h4>
